...
Client-side routing requires something known as a _router_.  A router in AngularJS, at a minimum, is used to define our routes, specify the template for that route, and specify which controller to attach to that view. You'll get to see routers in action next week.
...
In your starter code folder, you'll see some empty files and a folder.
...
- When you create a controller from scratch, what type of JS function is this?
